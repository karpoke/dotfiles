...
# https://avilpage.com/2014/11/python-automagically-reload-imports-in.html
# To manually reload modules:
#
#   # Python 2.x
#   imp.reload(module)
#   # Python 3.0-3.3
...
#
# IPython extension:Instead of manually reloading, ipython has autoreload extention which can auto
#
#   %load_ext autoreload
#   %autoreload 2
#
# To activate it when IPyton starts:
#   # Create default profile
#   $ ipython profile create
#   # And then copy the next two lines
